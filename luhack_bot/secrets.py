...
database_port = 42069
database_host = 'luhack-discord-verification-bot-database.cff2dtcegzwl.eu-west-2.rds.amazonaws.com'
database_password = ''

# Email credentials
email_username = 'luhack.discord.verifier.test@gmail.com'
email_password = 'H4tr3dC0pter'

# Secret bot client token
bot_client_token = 'NTAyOTQwODg5MTYxNjYyNDY1.DqvQyw.ZdewAkNVqze8_RrhLnriKqWpsLM'

# Aes key for email encryption
aes_encryption_key = 'A3n7UX9EkjP46RtfgDU9WdlZe'
